...
\begin{document}
    ...
    \label{opdracht1}
    \paragraph{
        Maak voor iedere query die je schrijft minimaal één alternatieve implementatie indien mogelijk en vergelijk de queryplannen.
        Kies op basis van het queryplan, performance en onderhoudbaarheid van de code de juiste query en verklaar jouw keuze.
    }
    \input{opdrachten/opdracht-01_1.tex}
    \clearpage
    \input{opdrachten/opdracht-01_2a.tex}
    \clearpage
    \input{opdrachten/opdracht-01_2b.tex}
    \clearpage
    \input{opdrachten/opdracht-01_3.tex}
    \clearpage
    \input{opdrachten/opdracht-01_4.tex}
    \clearpage
    \input{opdrachten/opdracht-01_5a.tex}
    \clearpage
    \input{opdrachten/opdracht-01_5b.tex}
    \clearpage
    ...
    Het kan zijn dat je een aantal al tijdens de casus DDDQ heb geédentificeerd en/of zelfs al gemaakt.
